...
import { AuthConsumer } from '../main/provedorAutenticacao.js'
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav">
                ...
                <NavbarItem render={props.isUserAuthenticated} onClick={props.deslogar} href="#/login" label="Sair" />
            </ul>
            </div>
        </div>
      </div>
...
export default () => (
  <AuthConsumer>
    {(context) => (
        <Navbar isUserAuthenticated={context.isAuthenticated} deslogar={context.endSection} />
    )}
  </AuthConsumer>
)